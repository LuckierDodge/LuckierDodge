...
- [magnificus/Procedural-Cities](https://github.com/magnificus/Procedural-Cities) - master thesis (1 day ago)
- [Neumi/ethersweep](https://github.com/Neumi/ethersweep) - Open Source, easy to use Ethernet connected stepper motor controller. Built in FreeCAD, KiCAD and Arduino. (5 days ago)
- [cbedio/OpenScout](https://github.com/cbedio/OpenScout) -  (5 days ago)
