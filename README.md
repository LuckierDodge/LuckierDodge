...
- [kensanata/hex-mapping](https://github.com/kensanata/hex-mapping) - Tools to work with hex maps for roleplaying games. Usually web applications written in Perl and producing SVG output. (3 days ago)
- [uleroboticsgroup/yasmin](https://github.com/uleroboticsgroup/yasmin) - YASMIN (Yet Another State MachINe) (4 days ago)
- [camkisailus/LLMPlan](https://github.com/camkisailus/LLMPlan) -  (6 days ago)
