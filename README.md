...
- [AD-SDL/webcam_module](https://github.com/AD-SDL/webcam_module) - An example module that supports taking a snapshot with a webcam or other video device. (2 months ago)
...
- [maffettone/erobs](https://github.com/maffettone/erobs) -  (4 months ago)
