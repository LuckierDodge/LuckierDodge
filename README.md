...
- [AD-SDL/hig4_module](https://github.com/AD-SDL/hig4_module) - Module for communicating with the HiG4 Centrifuge (today)
...
- [norlab-ulaval/RTS_project](https://github.com/norlab-ulaval/RTS_project) - Code and Python library to process Robotic Total Stations data (2 days ago)
- [rlane/oort3](https://github.com/rlane/oort3) - A space fleet programming game (3 days ago)
